function res = Cutof_LQR_closed_loop_MT2_comp(DS,linModes)
...
print -djpeg -r300 IRsVonShell_HSVs.jpg;
...
set(gcf, 'Position', [0 0 600 500]);
% print('-depsc', 'OscillatorChain_ControlPolicy_outdof5_woFeedback.eps')
print -djpeg -r300 IRsVonShell_DCGains.jpg;


disp('MHSV sum of the first 2 pair')
disp(sum(HSV_per(1:2)))
disp('DCgain sum of the first 2 pair')
disp(sum(DC_per(1:2)))
res{1} = HSV_per;
res{2} = DC_per;
