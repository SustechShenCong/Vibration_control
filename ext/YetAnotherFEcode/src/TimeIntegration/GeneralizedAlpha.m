...
% [1] Arnold, M., & Brs, O. (2007). Convergence of the generalized-alpha scheme 
% for constrained mechanical systems. Multibody System Dynamics, 18(2), 185202. 
...
% For the time being, we consider systems without constraints.
    ...
    methods
        function TI = GeneralizedAlpha(varargin)
            ...
            addParameter(p,'t0', TI.t0, @(x)validateattributes(x,{'numeric'},{'nonempty'}));
